...
// FIX: Change component to React.FC to properly handle key props
export const HomeFilledIcon: React.FC<{ className?: string }> = ({ className }) => (
...
// FIX: Change component to React.FC to properly handle key props
export const StreamHubLogo: React.FC<{ className?: string }> = ({ className }) => (
...
// FIX: Change component to React.FC to properly handle key props
export const StreamHubIcon: React.FC<{ className?: string }> = ({ className }) => (
...
// FIX: Change component to React.FC to properly handle key props
export const MicActiveIcon: React.FC<{ className?: string }> = ({ className }) => (
